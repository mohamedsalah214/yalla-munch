    ...
    <div class="error-container">
        <div class="main-content">
            ...
            <div class="right-content lg-w-100">
                <h1 class="error-sign">408</h1>
                <h2 class="error-message">Request Timeout</h2>
                <p class="para">The server timed out waiting for the request. According to HTTP specifications: "The
                    client did not produce a request within the time that the server was prepared to wait.</p>
