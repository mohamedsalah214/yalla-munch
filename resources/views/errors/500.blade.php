    ...
    <div class="error-container">
        <div class="main-content">
            <div class="left-content lg-none">
                <img src="{{ asset('assets/images/error.png') }}" alt="img" class="error-image">
            </div>
            <div class="right-content lg-w-100">
                <h1 class="error-sign">500</h1>
                <h2 class="error-message">internal Server Error</h2>
                <p class="para">Oops,Try to refresh this page or feel free to contact us if the problem persists.</p>
